...
public class FieldEntryAdapter extends ArrayAdapter<FieldEntry> {
	...
	v = fe.expandView();
	/*
	 * if(fe.getType().equals(Type.TEXT)) { LayoutInflater vi =
	 * (LayoutInflater
	 * )getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE); v =
	 * vi.inflate(R.layout.textfieldentry, null); v = fe.expandView();
	 * 
	 * }
	 */
	/*
	 * if (v == null) { //TODO fix LayoutInflater vi =
	 * (LayoutInflater)getContext
	 * ().getSystemService(Context.LAYOUT_INFLATER_SERVICE); //v =
	 * vi.inflate(R.layout.fieldentryrow, null); }
	 */
